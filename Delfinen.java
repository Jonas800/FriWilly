...
public class Delfinen{
   ...
   public static void traener(ArrayList<Medlem> alleMedlemmer, ArrayList<Resultat> alleResultater)throws Exception{
      Scanner console = new Scanner(System.in);
      System.out.println("1: Se konkurrencesvoemmere og resultater\n2: Se top 5\n3: Opret resultater\n0: Tilbage til hovedmenu");
      int traenerValg = console.nextInt();
      switch(traenerValg){
         case 1:
            visKonkurrenceSvoemmereOgResultater(alleMedlemmer); //done
            break;
         case 2:
            int disciplinValg = 0;
            do{
   ...
   public static void visMedlemmersKontingent(ArrayList<Medlem> alleMedlemmer){
      System.out.printf("%-5s%-20s%-15s%-15s\n", "ID", "Navn", "Kontingent", "Betalingsstatus");
      for(Medlem m : alleMedlemmer){
         String bs = m.getHarBetalt() == true ? "Betalt" : "Restance";
         System.out.printf("%-5d%-20s%-15s%-15s\n", m.getID(), m.getFornavn() + " " + m.getEfternavn(), m.getKontigent(), bs);
      }
   }
   
   public static void haandterKontingent(ArrayList<Medlem> alleMedlemmer) throws Exception{
      visMedlemmersKontingent(alleMedlemmer);
   ...
   public static void opdaterMedlemmer(ArrayList<Medlem> alleMedlemmer, ArrayList<Resultat> alleResultater) throws Exception{
      ...
      Scanner console = new Scanner(System.in);
      System.out.println("Vaelg et id for at aendre et medlem: ");
      tjek(console);
      int id = console.nextInt();
      do{
      ...
      System.out.println("Tak og vaer venlig at komme igen!\n");
