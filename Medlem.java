...
public class Medlem{
   ...
   public Medlem(int id, String fornavn, String efternavn, String titel, String fdatoString, boolean aktivitetsform, boolean erMotionist, boolean harBetalt) throws Exception{
